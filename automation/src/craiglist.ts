...
export const postCraigsListAd = async (
    ...
    await stagehand.page.fill('input[name="PostingTitle"]', postDetails.postingTitle)
    await stagehand.page.fill('input[name="price"]', postDetails.price.toString())
    await stagehand.page.fill('textarea[name="PostingBody"]', postDetails.description)
